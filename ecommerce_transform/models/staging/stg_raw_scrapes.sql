...
SELECT
    ...
    JSON_EXTRACT_SCALAR(raw_payload, '$.product_name') AS product_name,
    JSON_EXTRACT_SCALAR(raw_payload, '$.product_url') AS product_url,
...
WHERE JSON_EXTRACT_SCALAR(raw_payload, '$.product_url') IS NOT NULL
