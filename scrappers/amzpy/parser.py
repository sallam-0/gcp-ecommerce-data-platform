...
if TYPE_CHECKING:
    from .session import AmzSession

from .utils import extract_brand_name, format_canonical_url, parse_amazon_url, extract_asin
    ...
    try:
        ...
        for container in product_containers:
            ...
            try:
                ...
                product_data = {"asin": asin, "product_id": asin}
